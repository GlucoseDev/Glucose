...
public abstract class MinecraftServer implements ICommandSender, Runnable, IThreadListener, ISnooperInfo
{
    ...
    public void run()
    {
        try
        {
            if (this.startServer())
            {
                ...
                long i = 0L;
                this.statusResponse.setServerDescription(new TextComponentString(this.motd.replace("&", "\\u00A7"))); // wonder if this will work
    ...
    public String getServerModName() {
        return "Glucose"; // Name in F3 menu and is also returned in ping
    }
