...
public class DedicatedServer extends MinecraftServer implements IServer
{
    ...
    public boolean startServer() throws IOException
    {
        ...
        thread.start();
        LOGGER.info("This version of Minecraft is provided by Glucose!");
        ...
        else
        {
            ...
            this.setAllowFlight(this.settings.getBooleanProperty("allow-flight", true));
            ...
            this.setForceGamemode(this.settings.getBooleanProperty("force-gamemode", true));
            ...
            catch (IOException ioexception)
            {
                ...
                LOGGER.error("The exception was: {}", (Object)ioexception.toString());
            ...
            if (!this.isServerInOnlineMode())
            {
                ...
                LOGGER.warn("If you are using BungeeCord, then ignore this message.");
            }
            ...
            else
            {
                ...
                LOGGER.info("Server started in {}.", (Object)s3);
                ...
                Items.field_190931_a.func_150895_a(CreativeTabs.SEARCH, NonNullList.func_191196_a());
                return true;
            }
        }
    }
