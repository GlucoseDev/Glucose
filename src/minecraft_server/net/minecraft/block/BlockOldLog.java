...
public class BlockOldLog extends BlockLog
{
    ...
    {
        p_149666_2_.add(new ItemStack(this, 1, BlockPlanks.EnumType.OAK.getMetadata()));
        p_149666_2_.add(new ItemStack(this, 1, BlockPlanks.EnumType.SPRUCE.getMetadata()));
        p_149666_2_.add(new ItemStack(this, 1, BlockPlanks.EnumType.BIRCH.getMetadata()));
        p_149666_2_.add(new ItemStack(this, 1, BlockPlanks.EnumType.JUNGLE.getMetadata()));
    }
