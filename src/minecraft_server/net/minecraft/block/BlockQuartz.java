...
public class BlockQuartz extends Block
{
    ...
    {
        p_149666_2_.add(new ItemStack(this, 1, BlockQuartz.EnumType.DEFAULT.getMetadata()));
        p_149666_2_.add(new ItemStack(this, 1, BlockQuartz.EnumType.CHISELED.getMetadata()));
        p_149666_2_.add(new ItemStack(this, 1, BlockQuartz.EnumType.LINES_Y.getMetadata()));
    }
