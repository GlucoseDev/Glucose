...
public class BlockNewLog extends BlockLog
{
    ...
    {
        p_149666_2_.add(new ItemStack(this, 1, BlockPlanks.EnumType.ACACIA.getMetadata() - 4));
        p_149666_2_.add(new ItemStack(this, 1, BlockPlanks.EnumType.DARK_OAK.getMetadata() - 4));
    }
