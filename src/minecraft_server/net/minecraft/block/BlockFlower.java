...
public abstract class BlockFlower extends BlockBush
{
    ...
    {
        for (BlockFlower.EnumFlowerType blockflower$enumflowertype : BlockFlower.EnumFlowerType.func_176966_a(this.getBlockType()))
        {
            p_149666_2_.add(new ItemStack(this, 1, blockflower$enumflowertype.getMeta()));
        }
    }
