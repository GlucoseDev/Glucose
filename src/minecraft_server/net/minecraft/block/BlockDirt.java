...
public class BlockDirt extends Block
{
    ...
    {
        p_149666_2_.add(new ItemStack(this, 1, BlockDirt.DirtType.DIRT.getMetadata()));
        p_149666_2_.add(new ItemStack(this, 1, BlockDirt.DirtType.COARSE_DIRT.getMetadata()));
        p_149666_2_.add(new ItemStack(this, 1, BlockDirt.DirtType.PODZOL.getMetadata()));
    }
